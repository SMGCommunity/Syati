...
public:
	...
	virtual void ~PoltaActionSequencer();
	...
	/// <returns>mCurrentAction->update();</returns>
	bool updateAction();
	bool startAction();
...
namespace NrvPoltaActionSequencer {
	NERVE(PoltaActionSequencerNrvWaitStart);
	NERVE(PoltaActionSequencerNrvOpeningDemo);
	NERVE(PoltaActionSequencerNrvBattleLv1);
	NERVE(PoltaActionSequencerNrvPowerUpDemo);
	NERVE(PoltaActionSequencerNrvBattleLv2);
	NERVE(PoltaActionSequencerNrvDownDemo);
}